...
// Footer component: Displays footer content with sections like support, community, hosting, and about, along with social media links and copyright information
const Footer = () => {
  return (
